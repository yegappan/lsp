...
def LspInitOnce()
  ...
  prop_type_add('LspTextRef', {
    highlight: 'LspTextRef',
    override: opt.lspOptions.propOverride
  })
  prop_type_add('LspReadRef', {
    highlight: 'LspReadRef',
    override: opt.lspOptions.propOverride
  })
  prop_type_add('LspWriteRef', {
    highlight: 'LspWriteRef',
    override: opt.lspOptions.propOverride
  })
